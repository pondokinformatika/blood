...
<div class="register-box">
  <div class="register-logo">
    <a href="{{asset('AdminLTE-2.4.4/index2.html')}}"><b>Admin</b>LTE</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>

    <form action="{{route('pendonor.register')}}" method="post">
    ...
    <a href=" {{route('pendonor.login')}} " class="text-center">Sudah Memiliki Akun</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
